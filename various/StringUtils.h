...
public:
    ...
    template<typename T>
    inline StringDecorator &operator=(T &&other);

    template<typename T, typename = typename std::enable_if_t<std::is_convertible_v<StringType, T>>>
    ...
    template<typename T>
    inline StringDecorator &operator+=(const T &t);
    ...
    template<class T>
    inline size_type find_first_not_of(const T &t, size_type pos = 0) const noexcept;
    ...
    template<class T>
    inline size_type find_last_of(const T &t, size_type pos = npos) const noexcept;
    ...
    template<class T>
    inline size_type find_last_not_of(const T &t, size_type pos = npos) const noexcept;
    ...
    template<typename T>
    inline StringDecorator &append(const T &t);
...
template<typename StringType>
inline std::ostream &operator<<(std::ostream &os, const StringDecorator<StringType> &decorator);
