...
template<typename StringType>
typename StringDecorator<StringType>::reference StringDecorator<StringType>::at(size_type pos) {
    return _data.at(pos);
}
...
template<typename StringType>
typename StringDecorator<StringType>::CharT &StringDecorator<StringType>::front() {
    return _data.front();
}

template<typename StringType>
const typename StringDecorator<StringType>::CharT &StringDecorator<StringType>::front() const {
    return _data.front();
}

template<typename StringType>
typename StringDecorator<StringType>::CharT &StringDecorator<StringType>::back() {
    return _data.back();
}

template<typename StringType>
const typename StringDecorator<StringType>::CharT &StringDecorator<StringType>::back() const {
    return _data.back();
}

template<typename StringType>
typename StringDecorator<StringType>::CharT *StringDecorator<StringType>::data() {
    return _data.data();
}

template<typename StringType>
const typename StringDecorator<StringType>::CharT *StringDecorator<StringType>::data() const {
    return _data.data();
}

template<typename StringType>
typename StringDecorator<StringType>::iterator StringDecorator<StringType>::begin() noexcept {
    return _data.begin();
}

template<typename StringType>
typename StringDecorator<StringType>::const_iterator StringDecorator<StringType>::begin() const noexcept {
    return _data.begin();
}

template<typename StringType>
typename StringDecorator<StringType>::const_iterator StringDecorator<StringType>::cbegin() const noexcept {
    return _data.cbegin();
}

template<typename StringType>
typename StringDecorator<StringType>::iterator StringDecorator<StringType>::end() noexcept {
    return _data.end();
}

template<typename StringType>
typename StringDecorator<StringType>::const_iterator StringDecorator<StringType>::end() const noexcept {
    return _data.end();
}

template<typename StringType>
typename StringDecorator<StringType>::const_iterator StringDecorator<StringType>::cend() const noexcept {
    return _data.cend();
}
...
template<typename StringType>
typename StringDecorator<StringType>::size_type StringDecorator<StringType>::size() const noexcept {
    return _data.size();
}

template<typename StringType>
typename StringDecorator<StringType>::size_type StringDecorator<StringType>::length() const noexcept {
    return _data.length();
}

template<typename StringType>
typename StringDecorator<StringType>::size_type StringDecorator<StringType>::max_size() const noexcept {
...
template<typename StringType>
typename StringDecorator<StringType>::size_type StringDecorator<StringType>::capacity() const noexcept {
...
template<typename StringType>
void StringDecorator<StringType>::pop_back() {
    _data.pop_back();
}
...
template<typename StringType>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find(const StringDecorator &str, size_type pos) const noexcept {
...
template<typename StringType>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find_first_of(const CharT *s, size_type pos) const {
    return _data.find_first_of(s, pos);
}

template<typename StringType>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find_first_of(CharT ch, size_type pos) const noexcept {
...
template<class T>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find_first_of(const T &t, size_type pos) const noexcept {
...
template<typename StringType>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find_first_not_of(CharT ch, size_type pos) const noexcept {
...
template<class T>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find_first_not_of(const T &t, size_type pos) const noexcept {
...
template<typename StringType>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find_last_of(CharT ch, size_type pos) const noexcept {
...
template<class T>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find_last_of(const T &t, size_type pos) const noexcept {
...
template<typename StringType>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find_last_not_of(CharT ch, size_type pos) const noexcept {
...
template<class T>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find_last_not_of(const T &t, size_type pos) const noexcept {
    return _data.find_last_not_of(t, pos);
}

template<typename StringType>
StringDecorator<StringType> &StringDecorator<StringType>::insert(size_type index, const CharT *s) {
...
template<typename StringType>
StringDecorator<StringType> &StringDecorator<StringType>::append(const StringDecorator &str) {
...
template<typename StringType>
StringDecorator<StringType> &
StringDecorator<StringType>::append(const StringDecorator &str, size_type pos, size_type count) {
    _data.append(str._data, pos, count);
    return *this;
}

template<typename StringType>
StringDecorator<StringType> &StringDecorator<StringType>::append(const CharT *s, size_type count) {
    _data.append(s, count);
    return *this;
}

template<typename StringType>
StringDecorator<StringType> &StringDecorator<StringType>::append(const CharT *s) {
    _data.append(s);
    return *this;
}
...
template<typename StringType>
StringDecorator<StringType> StringDecorator<StringType>::operator+(const StringDecorator &rhs) {
    return _data + rhs._data;
}

template<typename StringType>
StringDecorator<StringType> StringDecorator<StringType>::operator+(const StringType &rhs) {
    return _data + rhs;
}

template<typename StringType>
StringDecorator<StringType> StringDecorator<StringType>::operator+(const CharT *rhs) {
    return _data + rhs;
}
...
template<typename StringType>
int StringDecorator<StringType>::compare(const StringDecorator &str) const noexcept {
...
template<typename StringType>
int StringDecorator<StringType>::compare(size_type pos1, size_type count1, const StringDecorator &str, size_type pos2,
...
template<typename StringType>
int StringDecorator<StringType>::compare(size_type pos1, size_type count1, const CharT *s) const {
...
template<typename StringType>
template<class T>
int StringDecorator<StringType>::compare(size_type pos1, size_type count1, const T &t, size_type pos2,
                                         size_type count2) const {
...
template<typename StringType>
StringDecorator<StringType> &
StringDecorator<StringType>::replace(size_type pos, size_type count, const StringDecorator &str, size_type pos2,
                                     size_type count2) {
...
template<typename StringType>
StringDecorator<StringType> &
StringDecorator<StringType>::replace(size_type pos, size_type count, const StringType &str, size_type pos2,
                                     size_type count2) {
...
template<typename StringType>
int StringDecorator<StringType>::compare(size_type pos1, size_type count1, const StringType &str, size_type pos2,
                                         size_type count2) const {
...
template<typename StringType>
StringDecorator<StringType> &
StringDecorator<StringType>::append(const StringType &str, size_type pos, size_type count) {
    _data.append(str, pos, count);
    return *this;
}

template<typename StringType>
StringDecorator<StringType> &StringDecorator<StringType>::append(const StringType &str) {
    _data.append(str);
    return *this;
}

template<typename StringType>
StringDecorator<StringType> &StringDecorator<StringType>::append(size_type count, CharT ch) {
...
template<typename StringType>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::rfind(const StringType &str, size_type pos) const noexcept {
    return _data.rfind(str, pos);
}

template<typename StringType>
typename StringDecorator<StringType>::size_type
StringDecorator<StringType>::find(const StringType &str, size_type pos) const noexcept {
    return _data.find(str, pos);
}

template<typename StringType>
StringDecorator<StringType> &StringDecorator<StringType>::erase(size_type index, size_type count) {
